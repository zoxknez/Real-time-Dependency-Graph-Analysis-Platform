...
impl DependencyDiff {
    ...
    pub fn compute(old_deps: &HashMap<String, String>, new_deps: &HashMap<String, String>) -> Self {
...
impl ChangelogAnalyzer {
    ...
    pub fn analyze(&self, changelog: &str) -> ChangelogAnalysis {
        ...
        ChangelogAnalysis {
            ...
            has_migration_notes: lower.contains("migrate")
                || lower.contains("migration")
                || lower.contains("upgrade guide"),
